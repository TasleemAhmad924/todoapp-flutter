            ...
            itemBuilder: (BuildContext context, int index){
              if (index == 0){
                return Padding(
                  ...
                  children: <Widget>[
                  Text('Meine Aufgaben', style: TextStyle(color: Colors.black, fontSize: 40.0, fontWeight: FontWeight.bold ),),
                  SizedBox(height: 10.0),
                  Text('$completedTaskCount von ${snapshot.data.length}', style: TextStyle(color: Colors.grey, fontSize: 20.0, fontWeight: FontWeight.w600),),
                ]
                 )
               );
              }
